    ...
    <div className="min-h-screen pt-32 pb-24 flex items-center justify-center bg-[#ffffff] px-6">
      <div className="w-full max-w-md bg-[#fcfcfa] p-8 md:p-10 rounded border border-neutral-100 shadow-sm space-y-6">
        <div className="text-center space-y-2">
          <span className="text-[10px] text-[#7c562d] uppercase tracking-[0.2em] font-semibold">Welcome Back</span>
          <h2 className="text-3xl font-light font-serif text-neutral-900">Sign In</h2>
        </div>
        ...
        <div className="text-center pt-2">
          <p className="text-xs text-neutral-500">
            ...
            <Link to="/register" className="text-[#7c562d] hover:underline font-semibold">
              Sign Up
            </Link>
          </p>
        </div>
